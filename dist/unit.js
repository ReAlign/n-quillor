...
SnowTooltip.TEMPLATE = ['<a class="ql-preview" target="_blank" href="about:blank"></a>', '<input type="text" data-formula="e=mc^2" data-link="https://" data-video="https://">', '<a class="ql-action"></a>', '<a class="ql-remove"></a>'].join('');
...
var _quill = __webpack_require__(63);
